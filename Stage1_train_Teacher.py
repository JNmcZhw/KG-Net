...
from networks import TSNet2,VGG19PerceptualLoss
...
parser.add_argument('--save_teacher_model_dir', default='./checkpoints/Teacher/',help='Directory to save the model')
...
if __name__ == "__main__":
    ...
    train_dataset = TestDataloader(args.clear_dir,args.clear_dir,transform=transforms_train)
    ...
    for epoch in range(args.start_epoch, args.max_epoch + 1):
        ...
        if psnr_eval > max_psnr:
            ...
            torch.save(T.state_dict(), args.save_teacher_model_dir + args.category + "_T.pth")
